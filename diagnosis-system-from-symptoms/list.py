"""
This file contains two lists: all_features and all_disease. These lists are used in the app.py file for disease prediction.

all_features: A list of all possible symptoms.
all_disease: A list of all possible diseases.
"""
...
all_features = [
    ...
    "loss of balance", "unsteadiness", "weakness of one body side", "loss of smell",
    "bladder discomfort", "foul smell of urine", "continuous feel of urine", "passage of gases",
    ...
    "fluid overload.1", "blood in sputum", "prominent veins on calf", "palpitations",
